...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbweb2`.`usuario` ;
...
-- Table `dbweb2`.`voo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbweb2`.`voo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbweb2`.`assento` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbweb2`.`cartaodecredito` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbweb2`.`compravoo` ;
...
CREATE TABLE IF NOT EXISTS `dbweb2`.`compravoo` (
  ...
  UNIQUE INDEX `cartaodecredito_NUMEROCARTAO_UNIQUE` (`cartaodecredito_NUMEROCARTAO` ASC),
