...
CREATE TABLE IF NOT EXISTS `dbweb2`.`compravoo` (
  ...
  PRIMARY KEY (`idcompraVoo`, `valorTotalCompra`),
...
-- -----------------------------------------------------
-- Table `dbweb2`.`assentosComprados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbweb2`.`assentosComprados` (
  `assentosComprados` INT(11) NOT NULL,
  `voo_idvoo` INT(11) NOT NULL,
  INDEX `fk_assentosComprados_voo1_idx` (`voo_idvoo` ASC),
  CONSTRAINT `fk_assentosComprados_voo1`
    FOREIGN KEY (`voo_idvoo`)
    REFERENCES `dbweb2`.`voo` (`idvoo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
