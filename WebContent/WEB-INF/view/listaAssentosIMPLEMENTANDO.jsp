	...
	<c:if test="${usuarioLogado.isAdm ==  'FALSE'}">
		<c:import url="navBarCli.jsp" />
		    ...
		    <%-- </c:if> --%>
								...
								<input type="hidden" name="vooId" value="${vooId}"> <input
									type="hidden" name="idVooVolta" value="${vooIdVolta}">
								<input type="hidden" name="acao" value="AssentoOcupa"> <br>
		...
		<br>
		    ...
		    <%-- </c:if> --%>
									...
									<input type="hidden" name="ocupante"
										value="${usuarioLogado.id}" /> <input type="hidden"
										name="vooId" value="${vooId}"> <input type="hidden"
										name="idVooVolta" value="${vooIdVolta}"> <input
							...
							<c:if test="${usuarioLogado.isAdm == 'FALSE'}">
								<form action="${linkEntradaServlet }" method="post">
									<input type="hidden" name="compradorId"
										value="${usuarioLogado.id}" /> <input type="hidden"
										name="idvoo" value="${vooId}"> <input type="hidden"
										name="idvooVolta" value="${vooIdVolta}"> <input
